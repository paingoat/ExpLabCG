...
from .layers.gla.gla import GLSA, GLCA, DEFAULT_GLA_CONFIG
...
class UNet2DGLAConditionModel(UNet2DConditionModel):
    ...
    def __init__(
        ...
        super(UNet2DGLAConditionModel, self).__init__(
            sample_size,
            in_channels,
            out_channels,
            center_input_sample,
    ...
    def forward(
        ...
        # return CustomOutput(sample=sample, block_outputs=[
        #     down_block_sample, mid_block_sample, up_block_sample
        # ])
